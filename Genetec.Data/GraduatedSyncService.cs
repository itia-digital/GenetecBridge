...
public class GraduatedSyncService(SyncWorker worker, ISourceUnitOfWork unitOfWork)
    : SyncServiceWorker(worker), ISyncService
{
    protected override string TypeOfRecord => "Graduated";
    ...
    {
        IAsyncEnumerable<List<UpRecordValue>> fetchedRecords = unitOfWork.Graduated
