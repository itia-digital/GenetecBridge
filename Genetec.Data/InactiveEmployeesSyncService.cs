...
public class InactiveEmployeesSyncService(SyncWorker worker, ISourceUnitOfWork unitOfWork)
    : SyncServiceWorker(worker), ISyncService
{
    protected override string TypeOfRecord => "Inactive employees";
    ...
    {
        IAsyncEnumerable<List<UpRecordValue>> fetchedRecords = unitOfWork.InactiveEmployees
